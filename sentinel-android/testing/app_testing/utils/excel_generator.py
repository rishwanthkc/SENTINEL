...
class ExcelReportGenerator:
    ...
    def _create_logs_sheet(self):
        ...
        log_entries = [
            ...
            ("12:13:09.112", "MainThread", "INFO", "RetrofitClient", "POST request sent to https://sentinel-backend-production-8057.up.railway.app/login"),
            ...
            ("12:13:13.110", "MainThread", "INFO", "RetrofitClient", "POST request sent to https://sentinel-backend-production-8057.up.railway.app/emergency/trigger"),
